...
**Current state: built, run on the real corpus, and tested.** 290 tests pass in about twenty-five seconds, plus 205 browser checks: 45 in `tests/e2e_check.py`, 68 in `tests/e2e_upload_check.py`, and 92 in `tests/e2e_cohort_check.py`.
...
/Users/josh/Bridge-RNA/.venv/bin/python -m pytest tests/ -q              # 290 tests, about twenty-five seconds
...
/Users/josh/Bridge-RNA/.venv/bin/python tests/e2e_cohort_check.py        # 92 cohort checks, about four minutes
```
