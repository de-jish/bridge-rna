...
**Current state: built, run on the real corpus, and tested.** 307 tests pass in about twenty-five seconds, plus 242 browser checks: 50 in `tests/e2e_check.py`, 68 in `tests/e2e_upload_check.py`, and 124 in `tests/e2e_cohort_check.py`.
...
/Users/josh/Bridge-RNA/.venv/bin/python -m pytest tests/ -q              # 307 tests, about twenty-five seconds
...
/Users/josh/Bridge-RNA/.venv/bin/python tests/e2e_cohort_check.py        # 124 cohort checks, about four minutes
```
