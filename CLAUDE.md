...
**Current state: built, run on the real corpus, and tested.** 330 tests pass in about twenty-five seconds, plus 264 browser checks: 50 in `tests/e2e_check.py`, 68 in `tests/e2e_upload_check.py`, and 146 in `tests/e2e_cohort_check.py`.
