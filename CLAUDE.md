...
**Current state: built, run on the real corpus, and tested.** 258 tests pass in about twenty-five seconds, plus 173 browser checks: 45 in `tests/e2e_check.py`, 68 in `tests/e2e_upload_check.py`, and 60 in `tests/e2e_cohort_check.py`.
